...
switch (true) do {
	...
	case (__A2only) : {
		...
		EVO_pweapons = ["m16a4_acg","M9","Laserdesignator","NVGoggles"];
	};
...
#else
EVO_rank1_vecs = ["Mi17_CDF","HMMWV_Armored","HMMWV_M2","HMMWV_TOW","HMMWV_MK19","Mi17_Civilian","LAV25","AAV","BRDM2_CDF","BRDM2_ATGM_CDF","UAZ_AGS30_CDF","UAZ_MG_CDF","BMP2_CDF"];
Evo_Rank2_vecs = ["HMMWV_Avenger","MH60S","M1A1","T72_CDF","ZSU_CDF"];
EVO_rank3_vecs = ["MLRS","M1A2_TUSK_MG","UH1Y","MV22"];
EVO_rank4_vecs = ["M119","AH64D","AH1Z","AH64D_Sidewinders","C130J","Mi24_D"];
